...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("painter_name", sa.String(length=180), nullable=False),
        sa.Column("painter_phone", sa.String(length=40), nullable=True),
        sa.Column("quantity", sa.Numeric(14, 3), nullable=False),
        sa.Column("token_value", sa.Numeric(14, 2), nullable=False),
        sa.Column("total_amount", sa.Numeric(14, 2), nullable=False),
        sa.Column("status", sa.Enum("PENDING", "PAID", "VOID", name="tokenclaimstatus"), nullable=False),
