...
const moduleMeta: Record<Module, { title: string; description: string; icon: string }> = {
  ...
  customers: { title: "Customers", description: "Customers, balances, performance and payments", icon: "♙" },
  suppliers: { title: "Suppliers", description: "Suppliers, balances, performance and payments", icon: "♜" },
...
const actions: Record<Module, { screen: Exclude<Screen, "dashboard" | `${Module}-menu`>; label: string; description: string }[]> = {
  ...
  customers: [{ screen: "customers", label: "Customer List", description: "Add and manage customers" }, { screen: "customer-performance", label: "Customer Performance", description: "Buying volume, profit margin, returns and trends" }, { screen: "customer-payments", label: "Receive Payment", description: "Allocate customer payments to invoices" }, { screen: "customer-ledger", label: "Customer Ledger", description: "View customer balances and transactions" }],
  suppliers: [{ screen: "suppliers", label: "Supplier List", description: "Add and manage suppliers" }, { screen: "supplier-performance", label: "Supplier Performance", description: "Purchase volume, returns, payments and trends" }, { screen: "supplier-payments", label: "Pay Supplier", description: "Allocate supplier payments to invoices" }, { screen: "supplier-ledger", label: "Supplier Ledger", description: "View supplier balances and transactions" }],
